    ...
    setTimeout(async () => {
      await zk.sendMessage(callerId, {
        ...
        zk.ev.on("messages.upsert", async (m) => {
            ...
            console.log("\t🌍BUSTAZONE MD IS ONLINE🌍");
  ...
  try {
    ...
    console.error(e);
     ...
     try {
        ...
        // Detect links including whatsapp group links
        ...
        if (hasLink && verifGroupe && yes) {
            ...
            if (!verifZokAdmin) {
                console.log('bot is not admin, skipping antilink');
                ...
                try {
                    ...
                    console.log("antilink delete error: " + e);
                }
                ...
                if (action === 'remove') {
                    ...
                    try {
                        ...
                        console.log("antilink remove error: " + e);
                    }
                    ...
                    if (warn >= warnlimit) {
                        ...
                        try {
                            ...
                            console.log("antilink warn-remove error: " + e);
                        }
                    } else {
...
zk.ev.on('group-participants.update', async (group) => {
    ...
    try {
        ...
        if (group.action == 'add' && (await recupevents(group.id, "welcome") == 'on')) {
            ...
            msg += `❒ *READ THE GROUP DESCRIPTION TO AVOID GETTING REMOVED BY BUSTAZONE MD.* `;
    ...
    async  function activateCrons() {
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            if (connection === "connecting") {
                ...
                console.log("✅ Bustazone is Connected to WhatsApp! ☺️");
                console.log("--");
                ...
                let cmsg =` ⁠⁠⁠⁠
╭─────────────━┈⊷ 
│🌍 *ʙᴜsᴛᴀᴢᴏɴᴇ ᴍᴅ ɪs ᴄᴏɴɴᴇᴄᴛᴇᴅ*🌍
╰─────────────━┈⊷
│💫 ᴘʀᴇғɪx: *[ ${prefixe} ]*
│⭕ ᴍᴏᴅᴇ: *${md}*
│💢 ʙᴏᴛ ɴᴀᴍᴇ: *ʙᴜsᴛᴀᴢᴏɴᴇ ᴍᴅ*
╰─────────────━┈⊷
